...
class Servo(object):
    def __init__(self, bottom_address=0x40, up_address=0x41, pulse_min=544, pulse_max=2400, freq=50):
        self.offset = [[0, 0, 0]] * 6
        self.pwm_left = PCA9685(bottom_address)
        self.pwm_right = PCA9685(up_address)
